...
export const profile = {
  ...
  mission:
    "To provide top-quality spare parts that exceed customer expectations while building long-lasting relationships founded on trust, reliability and exceptional service.",
};
